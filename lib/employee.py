...
class Employee:
    ...
    def save(self):
        """ Insert a new row with the name and job title, and department id values of the current Employee object. Update object id attribute using the primary key value of new row.
